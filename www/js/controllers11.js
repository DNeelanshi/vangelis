angular.module('app.controllers', ['ngCordova'])
    ...
    .controller('homeCtrl', function ($scope, $httpParamSerializer, $stateParams, $translate, $state, $http, $ionicLoading, $window, Base_Url, $ionicPopup, $rootScope) {
    ...
    function ($scope, $state, $stateParams, $http, Base_Url, $window, $ionicLoading, $rootScope, $ionicPopup, $httpParamSerializer) {
        ...
        $scope.signin = function () {
            ...
            $http.post(Base_Url + 'users/logins', postdata).success(function (resp) {
                $ionicLoading.hide();
                console.log(resp);
                if (resp.status == true) {
    ...
    .controller('groupHotelCtrl', function ($scope, $stateParams, $window, Base_Url, $httpParamSerializer, $http, $state, $rootScope, $ionicLoading) {
        ...
        $http.post(link, $scope.hotelinfo).success(function (resp) {
            ...
            if (resp.status == true) {
                ...
                $scope.hotelbg = $httpParamSerializer({
    ...
    .controller('mapCtrl', function ($scope, $stateParams, $http, Base_Url, $rootScope, $ionicLoading, $state, $window) {
        ...
        $scope.mapclick = function (event, idd, reg, beachid) {
                    ...
                    for (var i = 0; i < resp.result.length; i++) {
                        for (var j = 0; j < resp.result[i].GuideList.length; j++) {
                            if (resp.result[i].GuideList[j].id == idd) {
                                ...
                                $window.localStorage.setItem('lat_city', JSON.stringify(resp.result[i].GuideList[j].latitude));
                                $window.localStorage.setItem('long_city', JSON.stringify(resp.result[i].GuideList[j].longitude));
            ...
            if ($rootScope.creid == "2") {
                //    $rootScope.city_immage = [];
                console.log("eeeeeeeeeeeeeeeeaaasssssssssssssttttttttttt")
    ...
    function ($scope, $stateParams, $http, $state, $window, Base_Url, $rootScope, $ionicLoading) {
        ...
        $http.get(link, $scope.greekword).success(function (resp) {
    ...
    function ($scope, $stateParams, $http, $state, $window, Base_Url, $rootScope, $ionicLoading) {
        ...
        //alert($scope.info);
        $http.get(link, $scope.info).success(function (resp) {
            $ionicLoading.hide();
            console.log(resp);
    ...
    // You can include any angular dependencies as parameters for this function
    // TIP: Access Route Parameters for your page via $stateParams.parameterName
    function ($scope, $stateParams, $translate, $http, $state, $window, Base_Url, $rootScope, $ionicPopup, $ionicLoading) {
            ...
            $http.post(link, $scope.shoping).success(function (resp) {
                ...
                if (resp.status == true) {
                    for (var i = 0; i < resp.result.length; i++) {
                        ...
                        if (resp.result[i].GuideShopping.image) {
    ...
    function ($scope, $stateParams, $rootScope, Base_Url, $http, $state, $cordovaGeolocation) {
        ...
        $scope.launchNavigator = function () {
            console.log($rootScope.lat_shop);
            console.log($rootScope.long_shop);
            $state.go('menu.directionsVillage', { latCity: $rootScope.lat_shop, longCity: $rootScope.long_shop });
    ...
    .controller('aboutcreteCtrl', function ($scope, $stateParams, $http, $state, $window, Base_Url, $rootScope, $ionicLoading) {
        ...
        $scope.xyz = function (descID, title_main, background, $index) {
                ...
                for (var i = 0; i < resp.result.length; i++) {
                    ...
                    if (resp.result[i].AboutCrete.id == $scope.h_id) {
                        ...
                        if ($scope.value.CreteDetail[index_value].Gastronomy.length > 0) {
                            ...
                            console.log($rootScope.crete_gastronomy);
                            $state.go('menu.product');
                        } else {
                            $rootScope.birthofzesus = $scope.value.CreteDetail[index_value];
    ...
    function ($scope, $stateParams, $http, $state, $window, Base_Url, $rootScope, $ionicLoading) {
        $ionicLoading.show();
        console.log('ajhsdfjkahsdjfhalsdfhjd=========');
        var link = Base_Url + 'Aboutcretes/guidetocretetitle';
        $http.get(link).success(function (resp) {
            $ionicLoading.hide();
            console.log(resp);
        ...
        $scope.guidevillage = function (creteid, title, image, $index) {
            ...
            if (creteid == 1) {
                ...
                $http.post(link, $scope.beaches_thirdFour).success(function (resp) {
                    $ionicLoading.hide();
                    console.log(resp);
                    $rootScope.bechesdata = resp.result[0].GuideCrete;
            ...
            $http.get(link).success(function (resp) {
                ...
                for (var j = 0; j < resp.result[0].GuideList.length; j++) {
                    ...
                    if (resp.result[0].GuideList[j].id == id) {
                        ...
                        $rootScope.latitude = resp.result[0].GuideList[j].latitude;
                        $rootScope.longitude = resp.result[0].GuideList[j].longitude;
                        this.arrayText = [{
                            id: id,
                            title: title,
                            ...
                            latitude:resp.result[0].GuideList[j].latitude,
                            longitude:resp.result[0].GuideList[j].longitude
                        }];
    ...
    .controller('heraklionCtrl', function ($scope, $httpParamSerializer, $ionicLoading, $stateParams, $rootScope, $state, Base_Url, $http, $cordovaGeolocation, $cordovaLaunchNavigator) {
        ...
        $scope.sightseeing = function (title, id) {
            ...
            $ionicLoading.show();
            $scope.sightseeings = $httpParamSerializer({
                id: $scope.sightseeing_id
            })
            console.log($scope.sightseeings);
            ...
            $http.post(link, $scope.sightseeings).success(function (resp) {
                ...
                for (var i = 0; i < resp.result.length; i++) {
                    ...
                    resp.result[i].GuideSightseeings.image = resp.result[i].GuideSightseeings.image.split(',');
    ...
    function ($scope, $stateParams, $rootScope, $cordovaGeolocation, $window, $http, $cordovaLaunchNavigator, $state, $ionicPopup, $timeout) {
        $scope.heralat = parseFloat($stateParams.heralat);
        $scope.heralong = parseFloat($stateParams.heralong);
        console.log($scope.heralat);
        console.log($scope.heralong);

        // $scope.launchNavigator = function (destination, start, options) {
        //     $state.go('menu.heradirection');
        // }
        ...
        var restdetails = [];
        var favrest = [];
        $rootScope.originaddress = '';
        $rootScope.destinationaddress = '';
        ...
        $cordovaGeolocation.getCurrentPosition(posOptions).then(function (position) {
                ...
                /****rahul code to get address by lat long**************/
                var geocoder = new google.maps.Geocoder();
                var latlng = new google.maps.LatLng($rootScope.lat, $rootScope.long);
                var request = {
                    latLng: latlng
                };
                geocoder.geocode(request, function (data, status) {
                    if (status == google.maps.GeocoderStatus.OK) {
                        if (data[0] != null) {
                            ...
                            $rootScope.originaddress = JSON.stringify(data[0].formatted_address);
                            
                        } else {
                        }
                    }
                    console.log($rootScope.originaddress);
                    /************************** end & start function for getting address by lat long ***************/
                console.log($rootScope.lat);
                console.log($rootScope.long);
                ...
                //var geocoder = new google.maps.Geocoder();
                var latlng1 = new google.maps.LatLng($scope.heralat, $scope.heralong);
                var request1 = {
                    latLng: latlng1
                };
                geocoder.geocode(request1, function (data, status) {
                    if (status == google.maps.GeocoderStatus.OK) {
                        if (data[0] != null) {
                            $rootScope.destinationaddress = JSON.stringify(data[0].formatted_address);
                            console.log($rootScope.destinationaddress);
                             /************** google map **************/
                $scope.map = {
                    control: {},
                    center: {
               ...
               // var geocoder = new google.maps.Geocoder();
                ...
                $scope.directions = {
                    origin: $rootScope.originaddress,// "sector 38 chandigarh",
                    destination: $rootScope.destinationaddress,//"sector 22 chandigarh",
                    showList: false
                }
    ...
    function ($scope, $stateParams, $rootScope, $cordovaGeolocation, $window, $http, $cordovaLaunchNavigator) {
        $scope.direction_lat = $stateParams.latCity;
        $scope.direction_long = $stateParams.longCity;
        // alert('lat:'+$stateParams.latCity+'Long:'+$stateParams.longCity);
        console.log($scope.direction_lat);
        console.log($scope.direction_long);
        ...
        $cordovaGeolocation.getCurrentPosition(posOptions).then(function (position) {
            ...
            var destinationlatlng = new google.maps.LatLng($scope.direction_lat, $scope.direction_long);
            var request = {
                latLng: latlng
            };
            var request2 = {
            ...
            /********** code for get address by lat long for current location *********/
            geocoder.geocode(request, function (data, status) {
                if (status == google.maps.GeocoderStatus.OK) {
                    if (data[0] != null) {
                        console.log("address is: " + data[0].formatted_address);
                        $rootScope.originaddress1 = data[0].formatted_address;
                        
                    } else {
                        //alert('address not found');
                    }
                }
                 /********** code for get address by lat long for destination */
                 var geocoder = new google.maps.Geocoder();
            geocoder.geocode(request2, function (data, status) {
                if (status == google.maps.GeocoderStatus.OK) {
                    if (data[0] != null) {
                        console.log("address is: " + data[0].formatted_address);
                        $rootScope.destinationaddress1 = data[0].formatted_address;
                        console.log(position);
                        $scope.map = {
                            control: {},
                            center: {
                        ...
                        var myOptions = {
                            zoom: 10,
                            center: new google.maps.LatLng(30.723866100000002, 76.8465688),
                            mapTypeId: google.maps.MapTypeId.ROADMAP
                        };
                        // Draw the map
                        var mapObject = new google.maps.Map(document.getElementById("map"), myOptions);
                        $scope.directions = {
                            origin: $rootScope.originaddress1,// "sector 38 chandigarh",
                            destination: $rootScope.destinationaddress1,//"sector 22 chandigarh",
                            showList: false
                        }
    ...
    .controller('villagesCtrl', function ($scope, $ionicSlideBoxDelegate, $stateParams, Base_Url, $http, $rootScope, $state, $ionicLoading, $cordovaGeolocation, $cordovaLaunchNavigator) {
        ...
        $http.post(link, $scope.east).success(function (response) {
            ...
            angular.forEach(response.result, function (value, key) {
                console.log(value);
                console.log(key);
                if (value.GuideVillage.id == $scope.estid) {
                    console.log(value);
                    $scope.east = value;
                }
            })
        ...
        $scope.launchNavigator = function (lat, long) {
            ...
            $state.go('menu.directionsVillage', { latCity: lat, longCity: long });
        }
    ...
    .controller('beachareanoethCtrl', function ($scope, $ionicPopup, $ionicLoading, $stateParams, $rootScope, $state, $window, Base_Url, $http, $cordovaGeolocation, $cordovaLaunchNavigator) {
        ...
        $http.post(link, $scope.beachnorth).success(function (response) {
            ...
            if (response.result.length > 0) {
                $ionicLoading.hide();
                angular.forEach(response.result, function (value, key) {
                    if (value.GuideBeache.image.indexOf(',') > -1) {
                        console.log(value.GuideBeache.image.split(','));
                        value.GuideBeache.image = value.GuideBeache.image.split(',');
                    }
                    //console.log(key);
                })
    ...
    function ($scope, $stateParams, $rootScope, $cordovaGeolocation, $cordovaLaunchNavigator, $state) {
        ...
        $scope.launchNavigator = function () {
            console.log($rootScope.lat_beach);
            console.log($rootScope.long_beach);
            $state.go('menu.directionsVillage', { latCity: $rootScope.lat_beach, longCity: $rootScope.long_beach });
